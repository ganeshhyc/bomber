        ...
        return function (dictUnfoldable) {
            return function (gen) {
                var unfold = function (v) {
                    ...
                    throw new Error("Failed pattern match at Control.Monad.Gen line 100, column 12 - line 102, column 35: " + [ v.constructor.name ]);
                };
        ...
        return function (gen) {
            var go = function (v) {
                return Data_Functor.mapFlipped((((dictMonadGen.Monad0()).Bind1()).Apply0()).Functor0())(gen)(function (a) {
                    ...
                    throw new Error("Failed pattern match at Control.Monad.Gen line 116, column 24 - line 118, column 23: " + [ a.constructor.name ]);
                });
            };
