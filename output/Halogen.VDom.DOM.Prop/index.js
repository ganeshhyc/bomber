...
var propToStrKey = function (v) {
    ...
    throw new Error("Failed pattern match at Halogen.VDom.DOM.Prop line 185, column 16 - line 193, column 1: " + [ v.constructor.name ]);
};
...
var functorElemRef = new Data_Functor.Functor(function (f) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Halogen.VDom.DOM.Prop line 50, column 1 - line 50, column 42: " + [ f.constructor.name, v.constructor.name ]);
    };
});
    ...
    return function (el) {
        var removeProp = function (prevEvents) {
            return function (v, v1) {
                ...
                throw new Error("Failed pattern match at Halogen.VDom.DOM.Prop line 171, column 5 - line 182, column 21: " + [ v1.constructor.name ]);
            };
        };
        ...
        var applyProp = function (events) {
            return function (v, v1, v2) {
                ...
                if (v2 instanceof BHandler) {
                    return function __do() {
                        setProperty("custom", propFromString(v2.value0), el)();
                        return v2;
                    };
                };
                throw new Error("Failed pattern match at Halogen.VDom.DOM.Prop line 109, column 5 - line 135, column 15: " + [ v2.constructor.name ]);
            };
        };
